...
public partial class Global : Node {
    ...
    public Node2D userScoreOrigin, oppScoreOrigin, oppPolygons, loadingInstance, loadingScreen;
	...
	public class UserPref : Node {
        ...
        public void WriteLocalUserPref() {
            try {
                FileStream outStream = new FileStream("userdata.set", FileMode.Create, FileAccess.Write);
    ...
    public void ScoreDisplayAndAnimate(int oppPoints) {
        ...
        animPack.PolygonScale(oppPolygons, (float)oppPoints/100, 1f);
