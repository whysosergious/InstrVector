...
public partial class Main : Node2D {
	...
	public string addressString = "192.168.0.149";
	private readonly int defaultPort = 4444;
	...
	public void JoinServer() {
		...
		GD.Print($"Trying to connect to server with address {address}");

		var clientPeer = new NetworkedMultiplayerENet();
		var result = clientPeer.CreateClient(address, defaultPort);
	...
	private void PlayerConnected(int id) {
		...
		RpcId(id, "RegisterPlayer", playerName, highscoreList[0].userScore);
	}
