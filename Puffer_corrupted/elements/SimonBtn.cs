...
public class SimonBtn : RigidBody2D {
    ...
    // input events
    public void _on_SimonBtn_input_event(Viewport viewport, InputEvent ev, int shape_idx) {
    ...
    public void AddStep() {
        ...
        RigidBody2D pointInstance = (RigidBody2D)g.main.pointNode.Instance();
		...
		g.main.PointAnimate(pointInstance);


        g.main.userScore += timingScore;
